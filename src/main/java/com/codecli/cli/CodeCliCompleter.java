...
import com.codecli.mcp.mention.AtMentionCompleter;
...
final class CodeCliCompleter implements Completer {
    private final Supplier<List<McpResourceDescriptor>> resourceSupplier;
    private final Supplier<List<Skill>> skillSupplier;

    CodeCliCompleter(Supplier<List<McpResourceDescriptor>> resourceSupplier) {
