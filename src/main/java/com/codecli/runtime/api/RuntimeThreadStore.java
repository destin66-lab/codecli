...
public class RuntimeThreadStore implements AutoCloseable {
    ...
    public static Path defaultDbPath() {
        String configured = firstNonBlank(System.getProperty("codecli.runtime.dir"),
                System.getenv("CODECLI_RUNTIME_DIR"));
        if (configured == null) {
            Path home = Path.of(System.getProperty("user.home"));
            configured = home.resolve(".codecli/runtime").toString();
        }
