...
public class LongTermMemory implements Memory {
    ...
    private static final String STORAGE_DIR_PROPERTY = "codecli.memory.dir";
    private static final String STORAGE_DIR_ENV = "CODECLI_MEMORY_DIR";
    private static final String MODERN_STORAGE_DIR_PROPERTY = "codecli.memory.dir";
    private static final String MODERN_STORAGE_DIR_ENV = "CODECLI_MEMORY_DIR";
    ...
    private static File resolveStorageDir() {
        ...
        File modern = new File(home, ".codecli/memory");
        File legacy = new File(home, ".codecli/memory");
        return modern.exists() || !legacy.exists() ? modern : legacy;
    }
