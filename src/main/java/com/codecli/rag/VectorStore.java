...
public class VectorStore implements AutoCloseable {
    ...
    public VectorStore(String projectPath) throws SQLException {
        ...
        String dbDir = firstNonBlank(
                System.getProperty("codecli.rag.dir"),
                System.getenv("CODECLI_RAG_DIR"));
        if (dbDir == null) {
            dbDir = new java.io.File(System.getProperty("user.home"), ".codecli/rag").getPath();
        }
