package com.codecli.mcp.transport;
    ...
    private void startStdoutReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[codecli] stdout reader stopped: " + e.getMessage());
            }
        }, "codecli-mcp-stdio-stdout");
    ...
    private void startStderrReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[codecli] stderr reader stopped: " + e.getMessage());
            }
        }, "codecli-mcp-stdio-stderr");
        thread.setDaemon(true);
        thread.start();
    }
