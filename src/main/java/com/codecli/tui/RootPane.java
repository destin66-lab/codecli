...
import com.codecli.tui.pane.FileTreePane;
import com.codecli.tui.pane.InputBar;
...
public class RootPane extends Panel {
     ...
     */
    public RootPane(CodeCliConfig config, LlmClient llmClient) {
        super();
    ...
    public boolean handleInput(KeyStroke keyStroke) {
        ...
        if (keyStroke.getKeyType() == KeyType.Character && keyStroke.isCtrlDown() && keyStroke.getCharacter() == 'P') {
            centerPane.appendSystemMessage("对话历史已持续保存到 ~/.codecli/history/。");
            return true;
        }
