...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(CodeCliConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("CodeCLI v16.0.0");
    ...
    public CodeCliConfig getConfig() {
        return config;
    }
}
