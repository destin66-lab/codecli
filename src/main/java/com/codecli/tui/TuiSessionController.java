...
import com.codecli.tui.history.ConversationSnapshot;
import com.codecli.tui.pane.CenterPane;
import com.codecli.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    private final CodeCliConfig config;
    ...
    public TuiSessionController(CodeCliConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "codecli-tui-agent-runner");
