...
class LlmClientFactoryTest {
    ...
    void createsGlm5vTurboClientWithMultimodalEndpoint() {
        CodeCliConfig config = new CodeCliConfig();
        config.getProviders().put("glm",
                new CodeCliConfig.ProviderConfig("test-glm-key", null, "glm-5v-turbo"));
    ...
    void createsStepClientFromConfiguredProvider() {
        ...
        config.getProviders().put("step",
                new CodeCliConfig.ProviderConfig("test-step-key", null, "step-3.5-flash-2603"));
    ...
    void createsStepClientFromStepfunAliasAndCustomBaseUrl() {
        ...
        config.getProviders().put("step",
                new CodeCliConfig.ProviderConfig(
                        "test-step-key",
    ...
    void returnsNullForUnknownProvider() {
        CodeCliConfig config = new CodeCliConfig();
        config.getProviders().put("unknown", new CodeCliConfig.ProviderConfig("test-key", null, "unknown-model"));
