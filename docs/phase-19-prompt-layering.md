...
```text
src/main/java/com/codecli/prompt/
...
2. 用户级覆盖：`~/.codecli/prompts/...`
3. 项目级覆盖：`.codecli/prompts/...`

例如：

```text
~/.codecli/prompts/base.md
~/.codecli/prompts/modes/agent.md
.codecli/prompts/modes/team-worker.md
```
...
- [x] 支持用户级覆盖 `~/.codecli/prompts/...`
- [x] 支持项目级覆盖 `.codecli/prompts/...`
- [x] 校验 `## Language`
- [x] ReAct 接入
