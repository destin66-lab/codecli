...
新增包：`src/main/java/com/codecli/snapshot/`
...
```text
~/.codecli/snapshots/<project_hash>/<worktree_hash>/.git
```
...
```bash
-Dcodecli.snapshot.enabled=false
-Dcodecli.snapshot.max=50
-Dcodecli.snapshot.excludes=...
```
